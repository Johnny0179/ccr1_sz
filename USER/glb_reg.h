...
typedef __packed struct{
	  ...
	  s32 PosSV;//set
	  s32 PosPV;//feedback
	  s32 PosLocked; //��Ӧ�������m1/m2/m3/4,��λ�ñ�ʾΪ�������������Ӧ��λ�á�����? ����m4/m5/6 , Ϊ����ƽ�������λ�á��˲�����Ϊ�ǲο���
	  s32 PosLimit; // ����һ���������λλ�á�?	
		s32 SpdSV;
	  s32 SpdPV;
	  ...
	  s16 MaxcurrentLocked;
		u16 RdUpdate; //1:��ʾ����ɣ������?���¡���������?��,��ô��Ѹ��?��0 .bit0:posSV, bit1:TrqPV, bit2:spdPV
		u16 init_ok;
		s32 PosPV_Last;
}SERV_PAR_TYPE;

typedef __packed struct{
	u16 PosFactor; //����λ�������趨��ʵ��λ�� = posset*DebugPosFactor;
	s16 PosOpenLen; //��բ�ɿ���λ������ ,actual = PosOpenLen * PosFactor;
...
//
	...
	u16 ErrCode;	//������
	u16 CmdRepState; // �������Ӧ״�? ����һ��������������Ӧ���� ���?0��NoErr�� ���������Ӧ�������Ӧ�Ĵ�����˵��������Ӧ��ԭ��
...
#define SERV0_BASE 250 //����ŷ������ڣ����ڹ㲥�����Ļ�����?
...
#define DEBUG_Pos_Xxx_BASE 109   //���ʡ� ʵ��λ�� = REG_DEBUG_PosSet*REG_DEBUG_Pos_Xxx, ͨ��REG_DEBUG_Pos_XxxΪ100 ��1000
